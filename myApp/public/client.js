let piecesArr = [];
const originPieces = [{name:"WhiteKing",type:"King",color:"white",src:"chess_pieces/wk.svg",originX:3,originY:7,x:3,y:7},{name:"WhiteQueen",type:"Queen",color:"white",src:"chess_pieces/wq.svg",originX:4,originY:7,x:4,y:7},
...
// emit on khi an nut play truyen originPieces vao piecesArr roi render ra


// on dragstart gui name cua quan co len 
// nhan ve mang cac vi tri co the di duoc 


// on dragend gui ten va vi tri quan co 
// nhan ve ket qua quan co co duoc di hay khong
